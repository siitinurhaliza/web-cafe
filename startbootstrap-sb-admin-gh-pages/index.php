<?php
                 include "koneksi.php";
                 $no=1;
                 $hasil = mysqli_query($koneksi, "SELECT * FROM tbl_kuliner");
                 $data = [];
            ...
            <div id="layoutSidenav_nav">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Lokasi Cafe And Resto - Pangkalan Kerinci</h1>
...
icon:myIcon
 ...
 <b></b>: <img src="welcome.jpg" alt="Welcome Image" width="300" height="100">
</p>
<p> 
<i class="fa-duotone fa-school"></i> 
<b>Cafe And Resto</b>: ${d.nama} </p>
<p> 
