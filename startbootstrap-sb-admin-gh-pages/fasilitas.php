    ...
    <body class="sb-nav-fixed">
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <a href="tambah-fasilitas.php" class="btn btn-primary mb-4"><i class="bi bi-bookmark-plus-fill">TAMBAH FASILITAS</i>
...
?>
    ...
    <script>
        <?php
                        if(isset($_GET['kode'])){
                             ...
                             mysqli_query($koneksi, "delete from tbl_fasilitas1 where id_fasilitas = '$_GET[kode]'");

                                 echo "Data Telah terhapus";
                                 echo "<meta http-equiv=refresh content=2;URL='fasilitas.php'>";
                }
        ...
        <style>
    /* CSS untuk mengatur border (garis) tabel */
    table.table {
    ...
    table.table th, table.table td {
        padding: 8px;
        text-align: left;
        border: 1px solid black; /* Garis hitam 1px pada sel tabel */
    }
    ...
    table.table tbody tr:nth-child(even) {
        background-color: lightgray; /* Warna latar belakang abu-abu muda untuk baris genap */
    }
</style>
</head>
<body class="sb-nav-fixed">
