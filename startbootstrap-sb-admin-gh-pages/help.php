 ...
 <div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">HelpDask</h1>
            <div class="card mt-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="assets/img/customer-service.png" class="img-fluid"  alt="HelpDask Image" width="600" height="400">
                        </div>
                        <div class="col-md-6">
                            <p class="card-text">Selamat datang di Cafe and Resto HelpDask. Kami siap untuk membantu Anda memahami dan menggunakan website kami dengan baik. Berikut beberapa panduan dasar:</p>
                            <ol>
                                <li><strong>Cara Menambahkan Kuliner Baru:</strong> Untuk menambahkan tempat kuliner baru, masuk ke halaman Data Kuliner. Klik tombol "Tambah Kuliner" dan isi semua informasi yang diperlukan, termasuk gambar kuliner. Tekan "Simpan" untuk menyimpan data kuliner baru.</li>
                                <li><strong>Cara Menghapus Kuliner:</strong> Untuk menghapus entri kuliner, pergi ke halaman Data Kuliner, pilih kuliner yang ingin dihapus, dan klik "Hapus". Pastikan Anda yakin sebelum menghapus karena tindakan ini tidak dapat dibatalkan.</li>
                                <li><strong>Cara Menggunakan Peta:</strong> Halaman Data Kuliner juga menampilkan peta dengan lokasi semua kuliner. Klik pada marker untuk melihat detail kuliner dan gambar terkait.</li>
                            </ol>
                            <p>Jika Anda memiliki pertanyaan lebih lanjut atau memerlukan bantuan, silakan hubungi tim dukungan kami:</p>
                            <ul>
                                <li><strong>Email Dukungan:</strong> <a href="mailto:support@cafeandrestoapp.com">support@cafeandrestoapp.com</a></li>
                                <li><strong>Nomor Telepon Dukungan:</strong> <a href="https://web.whatsapp.com/">web.whatsapp.com</a></li>
                            </ul>
                            <p>Tim dukungan kami siap membantu Anda dengan semua pertanyaan dan masalah yang mungkin Anda hadapi. Terima kasih telah menggunakan Cafe and Resto!</p>
                        </div>
                    </div>
                </div>
            </div>
