...
if(isset($_POST['proses'])){
    mysqli_query($koneksi,"insert into tbl_kuliner set
        ...
        <div id="layoutSidenav">
            ...
            <form action="" method="post" onsubmit="return konfirmasiData()">
                <div class="form-group">
                    <label for="nama" class="fw-bold">Layanan kuliner</label>
                ...
                <div class="form-group">
                    <label for="jam_buka" class="fw-bold">Jam Buka</label>
                ...
                <div class="form-group">
                    <label for="sosmed" class="fw-bold">Sosmed</label>
